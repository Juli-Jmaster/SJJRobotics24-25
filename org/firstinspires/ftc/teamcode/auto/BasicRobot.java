...
public interface BasicRobot {
    ...
    FixedPositionServo outtakeAngle = new FixedPositionServo("outtakeAngle", new double[]{0.435, 0.58});
    ...
    AjustableServo intakeSlide1 = new AjustableServo("intakeSlide1", 0,0,0.35,0.05);
    AjustableServo intakeSlide2 = new AjustableServo("intakeSlide2", 1, 1, 0.65, 0.05);
}
